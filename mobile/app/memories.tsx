...
export default function NewMemory(){
  ...
  return (
    <ScrollView className='flex=1' contentContainerStyle={{paddingBottom: bottom, paddingTop: top}}>
      <View className='flex-row px-8 mt-4 justify-between items-center'>
        <LogoNLW />
          ...
          return (
            <View key={memory.id} className='space-y-4'>
              ...
              <View className='space-y-4'>
                ...
                className='aspect-video w-full rounded-lf' alt='' />
                <Text className='font-body text-basic leading-relaxed text-gray-100'>
                  {memory.excerpt}
                </Text>
